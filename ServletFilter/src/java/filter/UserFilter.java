...
public class UserFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        boolean loginRequest = httpRequest.getRequestURI().equals(httpRequest.getContextPath() + "/login");

        if (loggedIn || loginRequest) {
            // Nếu người dùng đã đăng nhập hoặc đang yêu cầu trang đăng nhập, cho phép tiếp tục
